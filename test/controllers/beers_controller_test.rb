...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { brewery_id=integer: @beer.brewery_id=integer, name: @beer.name, style: @beer.style }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { brewery_id=integer: @beer.brewery_id=integer, name: @beer.name, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
